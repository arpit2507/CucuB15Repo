...
public class DataTableStepDef {
	...
	public void user_enters_user_surname(String surName) throws InterruptedException{
		driver.findElement(By.xpath(".//*[@id='u_0_l']")).sendKeys(surName);
		Thread.sleep(1000);
	}
	
	@But("User Mobile field should be blank")
	public void user_Mobile_field_should_be_blank() throws InterruptedException{
		String mobileActual =driver.findElement(By.xpath(".//*[@id='u_0_o']")).getAttribute("value");
	...
	public void enter_followind_data(DataTable table) throws InterruptedException{
		...
		driver.findElement(By.xpath(".//*[@id='u_0_j']")).sendKeys(values4);
		driver.findElement(By.xpath(".//*[@id='u_0_l']")).sendKeys(values5);
		driver.findElement(By.xpath(".//*[@id='u_0_o']")).sendKeys(values6);
		Thread.sleep(2000);
